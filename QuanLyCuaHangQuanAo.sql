...
INSERT INTO [User] (MaTK, TenTK, MatKhau, Email)
VALUES
('TK01', 'admin', 'admin', 'admin01@gmail.com'),
('TK02', 'user', 'user', 'user02@gmail.com')
...
INSERT INTO dbo.SanPham(MaSP, TenMH, Size, GiaBan, MaLoai, SoLuongTon)
VALUES
('SP01', N'SAND - BAD UNIFORM TEE','M', 300000, 'ML01',20),
('SP02', N'GREY - BAD UNIFORM TEE', 'L', 500000, 'ML02',20),
('SP03', N'ACID KAKI PANTS', 'XL', 700000, 'ML03',20),
('SP04', N'FALLEN ANGEL TEE', 'M', 750000, 'ML04',20),
('SP05', N'MOUNTAIN SHORT OLIVE', 'L', 600000, 'ML05',20),
('SP06', N'GREY DESTROYED SWEAT SHORT', 'M', 500000, 'ML06',20),
('SP07', N'BASIC TEE - WHITE', 'M', 400000, 'ML07',20),
('SP08', N'BAD LOVER TEE', 'L', 300000, 'ML08',20),
('SP09', N'BASIC TEE - MOCA', 'XL', 450000, 'ML09',20),
('SP10', N'KING CARD SHIRT', 'XL', 650000, 'ML10',20)
...
create proc sp_theloai_create 
 ...
 create proc sp_searchTL_by_MaTL
 @MaLoai nchar(20)
 as
 begin 
